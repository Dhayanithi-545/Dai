...
export default function LandingPage({ onNavigateToChat }) {
  ...
  // Scroll reveal
  useEffect(() => {
    const els = document.querySelectorAll(".landing-page .reveal-up");
  ...
  return (
    <div className="landing-page" style={s.page}>
      <style>{`
        .landing-page .reveal-up { opacity: 0; transform: translateY(28px); transition: opacity 0.65s ease, transform 0.65s ease; }
        .landing-page .reveal-up.visible { opacity: 1; transform: translateY(0); }
        ...
        .landing-page .hero-title { animation: heroFade 0.9s ease 0.1s both; }
        .landing-page .hero-sub { animation: heroFade 0.9s ease 0.28s both; }
        .landing-page .hero-input { animation: heroFade 0.9s ease 0.45s both; }
        .landing-page .hero-stats { animation: heroFade 0.9s ease 0.62s both; }
        .landing-page .hero-stats .reveal-up { opacity: 1; transform: translateY(0); }
        .landing-page .nav-in { animation: logoIn 0.6s ease both; }
        .landing-page input:focus { outline: none; }
        @media (max-width: 900px) {
          .landing-page .nav-links { display: none !important; }
          .landing-page .dai-feature-grid { grid-template-columns: 1fr !important; gap: 40px !important; }
          .landing-page .sustain-grid { grid-template-columns: repeat(2, 1fr) !important; }
        }
        @media (max-width: 600px) {
          .landing-page .stats-row { flex-wrap: wrap; gap: 20px; justify-content: center; }
          .landing-page .stat-divider { display: none; }
          .landing-page .sustain-grid { grid-template-columns: 1fr !important; }
          ...
          <div className="nav-links" style={s.navLinks}>
            {["Vehicles", "Technology", "Sustainability", "About"].map(l => (
              <a
                ...
                onMouseLeave={e => { e.currentTarget.style.color = "#8B91A0"; }}
              >
                {l}
              </a>
            ))}
      ...
      <section style={s.hero}>
        ...
        <div style={s.heroInner}>
          ...
          {/* ── STATS ── */}
          <div style={s.statsRow} className="hero-stats stats-row">
            <Stat value="6+" label="Vehicle Lines" delay={0} />
            <div className="stat-divider" style={s.statDivider} />
      ...
      <section style={{ ...s.section, background: "#13161B", borderTop: "1px solid #1E2530", borderBottom: "1px solid #1E2530" }}>
        <div style={s.sectionInner}>
          <div className="dai-feature-grid" style={s.daiFeatureGrid}>
            <div style={s.daiLeft}>
      ...
      <section style={s.section}>
        <div style={s.sectionInner}>
          ...
          <div className="sustain-grid" style={s.sustainGrid}>
            {[
...
const s = {
  ...
  heroTitle: { fontFamily: "'Syne', sans-serif", fontWeight: 800, fontSize: "clamp(38px, 6vw, 59px)", lineHeight: 1.08, letterSpacing: "-0.03em", marginBottom: 22, color: "#E8EAF0" },
